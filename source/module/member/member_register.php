...
if(!submitcheck('regsubmit', 0, $seccodecheck, $secqaacheck)) {
	...
	DB::query("INSERT INTO ".DB::table('common_member')." (uid, username, password, secques, adminid, groupid, regip,
		regdate, lastvisit, lastactivity, posts, credits, extcredits1, extcredits2, extcredits3, extcredits4, extcredits5,
		extcredits6, extcredits7, extcredits8, email, showemail, timeoffset, pmsound, invisible, newsletter)
		VALUES ('$uid', '$username', '$password', '$secques', '0', '$groupinfo[groupid]', '$_G[clientip]', '$_G[timestamp]', '$_G[timestamp]', '$_G[timestamp]', '0', '".$_G['setting']['initcredits']."', '$email', '0', '9999', '1', '0', '1')");
	*/
	if($regipsql) {
		DB::query($regipsql);
	}
	...
	if($fromuid) {
		//noteX去掉 updatecredits($fromuid, $_G['setting']['creditspolicy']['promotion_register']);

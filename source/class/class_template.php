...
class template {
	...
	function faqvar($var) {
		...
		if(isset($_G['cache']['faqs'][$var])) {
			return '<a href="faq.php?action=faq&id='.$_G['cache']['faqs'][$var]['fpid'].'&messageid='.$_G['cache']['faqs'][$var]['id'].'" target="_blank">'.$_G['cache']['faqs'][$var]['keyword'].'</a>';
		} else {
			return "!$var!";
		}
	}
